...
public class ExpelCoral extends SequentialCommandGroup
{
  ...
  public ExpelCoral(Elevator elevator, Manipulator manipulator, HID hid)
  {
    ...
    addCommands(
        ...
        new WaitUntilCommand(manipulator::isCoralExpelled).withTimeout(0.35), // Coral takes about 0.250 to pass through sensor plus some extra margin
        new WaitCommand(0.1),                                                 // Wait just a little longer to ensure it completely exits
