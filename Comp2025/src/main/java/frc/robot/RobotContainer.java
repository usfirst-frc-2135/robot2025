...
import frc.robot.commands.ScoreCoralLevels;
...
public class RobotContainer
{
  ...
  private void addDashboardWidgets( )
  {
    ...
    SmartDashboard.putData("ScoreCoralLevel", new ScoreCoralLevels(m_elevator, m_manipulator, m_led, m_hid, "CORAL4", "REEF4"));
  }
  ...
  private void initDefaultCommands( )
  {
    ...
    m_manipulator.setDefaultCommand(m_manipulator.getHoldPositionCommand("CURRENT"));
    m_elevator.setDefaultCommand(m_elevator.getHoldPositionCommand("CURRENT"));
