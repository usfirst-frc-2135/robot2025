...
public class RobotContainer
{
  ...
  private final HashMap<String, String> autoMap        = new HashMap<>(Map.ofEntries( //
      ...
      Map.entry(AutoChooser.AUTOPRELOADCORAL.toString( ) + StartPose.START1.toString( ), "Start1-RJ_RJ-S1R_S1R-RK"),
      Map.entry(AutoChooser.AUTOPRELOADCORAL.toString( ) + StartPose.START2.toString( ), "Start2-RH_RH-S1R_S1R-RI"),
      Map.entry(AutoChooser.AUTOPRELOADCORAL.toString( ) + StartPose.START3.toString( ), "Start3-RE_RE-S2L_S2L-RC"),

      Map.entry(AutoChooser.AUTOPRELOADCORAL2.toString( ) + StartPose.START1.toString( ),
          "Start1-RJ_RJ-S1R_S1R-RK_RK-S1R_S1R-RL"),
      Map.entry(AutoChooser.AUTOPRELOADCORAL2.toString( ) + StartPose.START2.toString( ),
          "Start2-RH_RH-S1R_S1R-RK_RK-S1R_S1R-RA"),
      Map.entry(AutoChooser.AUTOPRELOADCORAL2.toString( ) + StartPose.START3.toString( ),
          "Start3-RE_RE-S2L_S2L-RD_RD-S2L_S2L-RC"),

      Map.entry(AutoChooser.AUTOPRELOADCORAL3.toString( ) + StartPose.START1.toString( ),
          "Start1-RJ_RJ-S1R_S1R-RK_RK-S1L_S1R-RL_RL-S1R_S1R-RA"),
      Map.entry(AutoChooser.AUTOPRELOADCORAL3.toString( ) + StartPose.START2.toString( ),
          "Start2-RH_RH-S1R_S1R-RK_RK-S1R_S1R-RA_RA-S1R_S1R-RB"),
      Map.entry(AutoChooser.AUTOPRELOADCORAL3.toString( ) + StartPose.START3.toString( ),
          "Start3-RE_RE-S2L_S2L-RD_RD-S2L_S2L-RC_RC-S2L_S2L-RB"),
